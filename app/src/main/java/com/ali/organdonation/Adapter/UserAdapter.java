package com.ali.organdonation.Adapter;
...
import com.ali.organdonation.Email.JavaMailApi;
import com.ali.organdonation.Model.User;
import com.ali.organdonation.R;
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                reference.addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        ...
                                        String mSubject = "NEED 'URGENT'";
                                        String mMessage = "Hello"+ nameOfSender+ "," +nameOfSender+
                                                "would like to contact to you related organ. Here's his/her details:\n"+
                                                "Name: " + nameOfSender +"\n"+
                                                "Phone Number: " + phone +"\n"+
                                                "Email: " + email +"\n"+
                                                "Blood Group: " + blood +"\n"+
                                                "kindly reach out to him/her. Thank you \n" +
                                                "Organ Donation APP - DONATE ORGAN, MAKE BUDDIES AND SAVE LIVES!";
